...
| `compact` | object | on by default | [Context compaction](compaction.md): summarize old turns to keep a session under the window. Editable at runtime (⚙) and persisted. |
